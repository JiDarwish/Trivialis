  ...
  return (
    <>
      ...
      <div className="font-inter">
        <nav className="flex flex-col md:flex-row items-center justify-between flex-wrap bg-white py-6 px-6 md:px-24">
          <div className="flex items-center flex-shrink-0 text-black mr-6">
            <Link href='/'>
              <div className="w-48 relative">
                <Image
                  src="/logo_white_u.png"
                  alt="MarkU logo"
                  width={1546} // replace with the actual image width
                  height={561} // replace with the actual image height
                  layout="responsive"
                />
              </div>
            </Link>
        ...
        <main>
          ...
          <section className="flex font-extralight justify-around items-center flex-wrap mt-32 py-12 mb-20">
            <div>
              <div className="text-2xl md:text-4xl mb-3">Tired of marketing business on your own?</div>
              <div className="text-2xl md:text-4xl"><span className="text-[#5917b2] font-normal">MarkU</span> will do it for you</div>
            </div>
            <div className="mt-10 md:mt-0">
          ...
          <section className="bg-[#5917b2] text-white py-24 pl-6 md:pl-20 pr-6 md:pr-32">
            <div className="w-full md:w-7/12">
              <div className="text-2xl md:text-3xl mb-3">Feeling drowned in time-consuming marketing tasks that fall outside of your core expertise?</div>
              <div className="text-sm md:text-lg mb-10">You're not alone! Countless small and medium-size businessess struggle with this every day</div>
              <div className="text-md md:text-xl">MarkU was born out of the necessity to simplify and accelerate marketing activities, MarkU is designed to empower your business</div>
            </div>
          </section>

          <section id="about" className="flex flex-col md:flex-row justify-between items-center py-12 px-6 md:px-24">
            <div>
              <Image src="/social-media-marketing-in-mobile-online-3679266.png" alt="Marketing icon" width={500} height={500} />
            </div>
            <div className="w-full md:w-6/12">
              <div className="text-2xl md:text-4xl mb-7"><span className="text-[#5917b2]">MarkU</span> will:</div>
              <MarkuFeatures />
            </div>
          </section>


          <section id="team" className="bg-[#5917b2] text-white py-24 pl-6 md:pl-20 pr-6 md:pr-32 flex flex-col items-center">
            <div className="text-3xl md:text-5xl mb-5">Meet the team</div>
            <div className="w-full md:w-9/12">Welcome to the crew behind MarkU - a dynamic group of friends bound by a relentless quest for efficiency. We've harnessed this passion to craft MarkU, a cutting-edge tool designed for those who seek marketing success without the time-consuming hassle. With MarkU, we're not just streamlining marketing, we're redefining it - one efficient campaign at a time!</div>
          ...
          <section id="tryIt" className="py-12 ">
            <div className="w-10/12 md:w-7/12 mx-auto">
              ...
              <div className="text-sm md:text-lg mb-3">Sign up for our beta and we'll let you know when it's ready!</div>
              <BetaForm />
            </div>
          </section>

        </main>
        <footer className="flex justify-between my-10 mx-6 md:mx-12">
          <div>MarkU, 2023</div>
